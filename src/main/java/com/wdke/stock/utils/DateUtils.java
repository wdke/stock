...
public class DateUtils {
    ...
    public static String calDateDayDiff(Date currentDate, Date preDate) {
        ...
        if (currentDate != null && preDate != null) {
            if (currentDate.before(preDate)) {
                ...
                Date new_date = new Date(currentTime - preTime - 28800000L);
    ...
    public static Date convLongToDate(Long date, String pattern) {
        if (date == null) {
            ...
            String dateString = convLongToStr(date, pattern);
    ...
    public static Time timePlus(Time time, Time timePlus) {
        ...
        if (minus < 0L) {
            ...
            return minus == 0L ? getTime("00:00:00", "HH:mm:ss") : secToTime(minus);
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("getDateBeforeMin===>" + getDateBeforeMin((Date)null, 5));
        System.out.println("getDateBeforeMin===>" + getDateBeforeMin(new Date(), 5));
        System.out.println("getDateBeforeMin===>" + getDateBeforeMin(10));
        ...
        System.out.println("convLongToDate===>" + convLongToDate((new Date()).getTime(), ""));
        System.out.println("convLongToDate===>" + convLongToDate((new Date()).getTime(), (String)null));
        System.out.println("convLongToDate===>" + convLongToDate((new Date()).getTime(), "yyyy-MM-dd"));
        System.out.println("convLongToDate===>" + convLongToDate((new Date()).getTime(), "yyyy-MM-dd HH:mm:ss"));
        ...
        System.out.println("getDayNumBeforeToday===>" + getDayNumBeforeToday(1));
        ...
        System.out.println("getTimeEndOfDayAfterTaday===>" + getTimeEndOfDayAfterTaday(2));
        System.out.println("getDayNumAfterToday===>" + getDayNumAfterToday((Integer)null));
        System.out.println("getDayNumAfterToday===>" + getDayNumAfterToday(3));
        ...
        Long startDate = getFirstDayTimeFromMonth(getLastMonth()).getTime();
        ...
        System.out.println("getDayBeforeDate===>" + getDayBeforeDate((Date)null, 3));
        System.out.println("getDayBeforeDate===>" + getDayBeforeDate(new Date(), (Integer)null));
        System.out.println("getDayBeforeDate===>" + getDayBeforeDate(new Date(), 3));
        ...
        System.out.println("parserMonth===>" + parserMonth((String)null));
        System.out.println("getSundayBeforeDay===>" + getSundayBeforeDay((String)null, 1, (String)null));
        System.out.println("getSundayBeforeDay===>" + getSundayBeforeDay("", 1, ""));
        System.out.println("getSundayBeforeDay===>" + getSundayBeforeDay("2010-09-19", 1, "yyyy-MM-dd"));
        System.out.println("getSundayBeforeDay===>" + getSundayBeforeDay("2010/09/19 16:47:18.000", 1, "yyyy/MM/dd HH:mm:ss.SSS"));
