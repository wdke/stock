...
//                log.info("http GET 请求成功; [url={}]", url);
            ...
            log.error("同步http GET 请求失败,url:" + url, e);
...
//        System.out.println(sh600221.substring(sh600221.indexOf("data:{")+5,sh600221.indexOf("}")));
    }
